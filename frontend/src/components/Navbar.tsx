  ...
  const links: {
    ...
    { name: "About", href: "/about" },
    {
      ...
      children: [
        ...
        { name: "Sea Freight", href: "#" },
        { name: "Land Transport", href: "#" },
      ],
    },
    {
      name: "Resources",
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            className="md:hidden text-gray-700 text-3xl leading-none"
        ...
        <div
          ref={dropdownRef}
          className="hidden md:flex gap-6 text-gray-700 items-center font-sans relative"
        >
          {links.map((link, i) =>
            link.children ? (
